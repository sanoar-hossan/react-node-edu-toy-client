...
const Gallery = () => {
  useEffect(() => {
    ...
    return (
      <div>
      <div className='text-center text-black font-bold text-4xl py-5 my-4'>
        <h1>Our Toys Gallery</h1>
      </div>
      <div className="gallery">
        {toys.map((toy) => (
          <div
            ...
            data-aos="fade-up"  // Add AOS fade-up animation attribute
            data-aos-duration="500"  // Add AOS duration attribute
          >
