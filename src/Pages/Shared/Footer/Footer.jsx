    ...
    return (
      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between">
        ...
        <div className="flex mt-4 md:mt-0">
          ...
          <a href="#" className="text-gray-400 hover:text-white mx-3">About</a>
          <a href="#" className="text-gray-400 hover:text-white mx-3">Services</a>
      ...
      <div className="container mx-auto mt-4">
        ...
        <div className="flex justify-center mt-4">
          <span className="text-gray-400">&copy; 2023 Edu Toy. All rights reserved.</span>
        </div>
